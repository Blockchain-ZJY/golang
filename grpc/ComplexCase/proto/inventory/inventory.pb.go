...
type CheckStockRequest struct {
	...
	QuantityRequired int32                  `protobuf:"varint,2,opt,name=quantity_required,json=quantityRequired,proto3" json:"quantity_required,omitempty"`
...
func (x *CheckStockRequest) GetQuantityRequired() int32 {
	if x != nil {
...
type CheckStockReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsInStock     bool                   `protobuf:"varint,1,opt,name=is_in_stock,json=isInStock,proto3" json:"is_in_stock,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CheckStockReply) Reset() {
	*x = CheckStockReply{}
...
func (x *CheckStockReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckStockReply) ProtoMessage() {}

func (x *CheckStockReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_inventory_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckStockReply.ProtoReflect.Descriptor instead.
func (*CheckStockReply) Descriptor() ([]byte, []int) {
	return file_proto_inventory_proto_rawDescGZIP(), []int{1}
}

func (x *CheckStockReply) GetIsInStock() bool {
	if x != nil {
		return x.IsInStock
	}
	return false
...
const file_proto_inventory_proto_rawDesc = "" +
	"\n" +
	"\x15proto/inventory.proto\x12\tinventory\"_\n" +
	"\x11CheckStockRequest\x12\x1d\n" +
	"\n" +
	"product_id\x18\x01 \x01(\tR\tproductId\x12+\n" +
	"\x11quantity_required\x18\x02 \x01(\x05R\x10quantityRequired\"1\n" +
	"\x0fCheckStockReply\x12\x1e\n" +
	"\vis_in_stock\x18\x01 \x01(\bR\tisInStock2S\n" +
	"\tInventory\x12F\n" +
	"\n" +
	"CheckStock\x12\x1c.inventory.CheckStockRequest\x1a\x1a.inventory.CheckStockReplyB\x11Z\x0fproto/inventoryb\x06proto3"
...
var file_proto_inventory_proto_goTypes = []any{
	...
	(*CheckStockReply)(nil),   // 1: inventory.CheckStockReply
}
var file_proto_inventory_proto_depIdxs = []int32{
	0, // 0: inventory.Inventory.CheckStock:input_type -> inventory.CheckStockRequest
	1, // 1: inventory.Inventory.CheckStock:output_type -> inventory.CheckStockReply
