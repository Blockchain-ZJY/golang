...
type InventoryClient interface {
	// 检查库存 (一元 RPC)
	CheckStock(ctx context.Context, in *CheckStockRequest, opts ...grpc.CallOption) (*CheckStockReply, error)
}
...
func (c *inventoryClient) CheckStock(ctx context.Context, in *CheckStockRequest, opts ...grpc.CallOption) (*CheckStockReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckStockReply)
...
type InventoryServer interface {
	// 检查库存 (一元 RPC)
	CheckStock(context.Context, *CheckStockRequest) (*CheckStockReply, error)
...
func (UnimplementedInventoryServer) CheckStock(context.Context, *CheckStockRequest) (*CheckStockReply, error) {
...
func _Inventory_CheckStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).CheckStock(ctx, req.(*CheckStockRequest))
	}
